                ...
                <section className = 'team-content'>
                    ...
                    <div className = 'team-cards'>
                        <div className = 'each-tm-cards'>
                            <div className = 't-picture-side tope-daisy'>
                        ...
                        <div className = 'each-tm-cards'>
                            <div className = 't-picture-side tony-obi'>
                        ...
                        <div className = 'each-tm-cards'>
                            <div className = 't-picture-side dabotubo-briggs'>
                        ...
                        <div className = 'each-tm-cards'>
                            <div className = 't-picture-side francis'>
                        ...
                        <div className = 'each-tm-cards'>
                            <div className = 't-picture-side Ifeoluwa-Oloyede'>
                        ...
                        <div className = 'each-tm-cards'>
                            <div className = 't-picture-side segun-ebenizer' >
