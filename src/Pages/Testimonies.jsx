            ...
            <section className = 'testimonies-main'>
                    <section className = 'testimonies-content'>
                        <div className = 'testimonies-headline'>
                            ...
                            Doloribus quam neque quibusdam 
                            corrupti aspernatur corporis alias 
                            nisi dolorum expedita veritatis 
                        ...
                        <div className = 'test-cards'>
                            <div className = 'each-t-card'>
                                <center>
                                    <span className = 't-quot'><ImQuotesLeft /></span>
                                </center>
